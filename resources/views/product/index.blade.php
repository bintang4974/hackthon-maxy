...
@section('content')
    <div class="section">
        <div class="container">
            ...
            <div class="row">
                @foreach($products as $product) <!-- Perhatikan penggunaan variabel $products di sini -->
                    ...
                    <div class="property-item">
                        ...
                        <div class="property-content">
                           <div class="price mb-2"><span>Rp{{ number_format($product->price, 0, ',', '.') }}</span></div>
                            <div>
                                <h3 class="mb-2 text-black">{{ $product->name }}</h3>
                                <a href="{{ route('product.show', $product->id) }}" class="btn btn-primary py-2 px-3">See details</a>
                            </div>
                        </div>
                    </div>
                </div>
